...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Define a new clothing collection classification.</p>
    </div>
...
<div class="form-card">
    <form method="POST" action="category_add.php" novalidate>
        <div class="form-group">
            ...
            <input 
                ...
                class="form-control" 
                value="<?= e($name) ?>" 
                placeholder="e.g. Smart Athletic Footwear" 
                required 
                autofocus
            >
            <div class="form-help">A URL slug will be automatically created from this name.</div>
        </div>
